...
function theme.at_screen_connect(s)
    ...
    --local tags_ = {
    --    names = { "browser", "code", "chat", "terminal" },
    --    icons = { theme.dir .. "/icons/public_white.svg"
    --            , theme.dir .. "/icons/computer_white.svg"
    --            , theme.dir .. "/icons/chat.svg"
    --            , theme.dir .. "/icons/tag.svg"
    --            }
    --}
--
    --local tags = {}
    --for s = 1, screen.count() do
    --    tags[s] = awful.tag(tags_.names, s, awful.layout.layouts)
    --  
    --    for i, t in ipairs(tags[s]) do
    --        awful.tag.seticon(tags_.icons[i], t)
